...
class KlarnaOrderTest extends ModuleUnitTestCase {
    ...
    public function test__construct() {
        ...
        $basket = $this->getMockBuilder(Basket::class)
            ->setMethods([
                ...
                'getKlarnaOrderLines',
                'getShippingId',
                'tcklarna_calculateDeliveryCost',
                'getPriceForPayment'])
            ->getMock();
        ...
        $payment->expects($this->once())
            ->method('getCheckoutShippingSets')
            ->willReturn(['shippingSetMock' => $delivery]);
        ...
        $this->setModuleConfVar('iKlarnaValidation', 1, 'int');
        $this->setModuleConfVar('blKlarnaEnableAutofocus', false, 'bool');
        $this->setModuleConfVar('blKlarnaAllowSeparateDeliveryAddress', true, 'bool');
    ...
    public function testGetAdditionalCheckbox() {
        ...
        $this->setModuleConfVar('iKlarnaActiveCheckbox', 22, 'int');
        $result = $methodReflection->invoke($order);
        ...
        $this->setModuleConfVar('iKlarnaActiveCheckbox', 0, 'int');
        $result = $methodReflection->invoke($order);
