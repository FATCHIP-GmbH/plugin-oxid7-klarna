...
class KlarnaEMDTest extends ModuleUnitTestCase {
    ...
    public function testGetAttachments($data, $expectedResult) {
        $this->setModuleConfVar(
            'blKlarnaEmdCustomerAccountInfo',
            $data['blKlarnaEmdCustomerAccountInfo'],
            'bool'
        );
        $this->setModuleConfVar(
            'blKlarnaEmdPaymentHistoryFull',
            $data['blKlarnaEmdPaymentHistoryFull'],
            'bool'
        );
        ...
        $oMockCustomerInfo = $this->getMockBuilder(KlarnaCustomerAccountInfo::class)
            ->setMethods(['getCustomerAccountInfo'])
            ->getMock();
        ...
        $oMockPaymentHistory = $this->getMockBuilder(KlarnaPaymentHistoryFull::class)
            ->setMethods(['getPaymentHistoryFull'])
            ->getMock();
