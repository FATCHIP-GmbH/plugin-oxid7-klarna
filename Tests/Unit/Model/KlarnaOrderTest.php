...
class KlarnaOrderTest extends ModuleUnitTestCase
{
    ...
    public function testUpdateKlarnaOrder()
    {
        ...
        $client = $this->getMockBuilder(KlarnaOrderManagementClient::class)
            ->setMethods(['updateOrderLines'])->getMock();
    ...
    public function testCaptureKlarnaOrder()
    {
        ...
        $client->expects($this->once())
            ...
            ->with($this->callback(
                function ($data) {
                    return isset($data['shipping_info'])
                        && $data['shipping_info']
    ...
    public function test_setNumber()
    {
        ...
        $order  = $this->getMockBuilder(Order::class)->setMethods(['isKlarna', 'isKP'])->getMock();
    ...
    public function test_setNumber_KP_and_KIS($payID, $type, $configParamName)
    {
        ...
        $order = $this->getMockBuilder(Order::class)->setMethods(['isKlarna', 'isKP', 'isKIS'])->getMock();
        $class = new ReflectionClass(get_class($order));
        $method = $class->getMethod('setNumber');
        $method->setAccessible(true);
