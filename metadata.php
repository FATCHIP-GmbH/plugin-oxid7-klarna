...
$aModule = array(
    ...
    'templates'   => array(
        '@tcklarna/tcklarna_checkout.tpl'                => 'views/smarty/templates/checkout/tcklarna_checkout.tpl',
        '@tcklarna/tcklarna_amazon_login.tpl'            => 'views/smarty/templates/checkout/tcklarna_amazon_login.tpl',
        '@tcklarna/tcklarna_checkout_voucher_data.tpl'   => 'views/smarty/templates/checkout/inc/tcklarna_checkout_voucher_data.tpl',
        '@tcklarna/tcklarna_checkout_voucher_box.tpl'    => 'views/smarty/templates/checkout/inc/tcklarna_checkout_voucher_box.tpl',
        '@tcklarna/mplatess/tcklarna_checkout_voucher_errors.tpl' => 'views/smarty/templates/checkout/inc/tcklarna_checkout_voucher_errors.tpl',
        '@tcklarna/tcklarna_json.tpl'                    => 'views/smarty/templates/checkout/inc/tcklarna_json.tpl',
        '@tcklarna/tcklarna_country_select_popup.tpl'    => 'views/smarty/templates/checkout/inc/tcklarna_country_select_popup.tpl',
        '@tcklarna/tcklarna_checkout_login_box.tpl'      => 'views/smarty/templates/checkout/inc/tcklarna_checkout_login_box.tpl',
        '@tcklarna/tcklarna_checkout_address_box.tpl'    => 'views/smarty/templates/checkout/inc/tcklarna_checkout_address_box.tpl',
        //admin
        '@tcklarna/tcklarna_general.tpl'                 => 'views/smarty/templates/admin/tcklarna_general.tpl',
        '@tcklarna/tcklarna_design.tpl'                  => 'views/smarty/templates/admin/tcklarna_design.tpl',
        '@tcklarna/tcklarna_kco_config.tpl'              => 'views/smarty/templates/admin/tcklarna_kco_config.tpl',
        '@tcklarna/tcklarna_kp_config.tpl'               => 'views/smarty/templates/admin/tcklarna_kp_config.tpl',
        '@tcklarna/tcklarna_start.tpl'                   => 'views/smarty/templates/admin/tcklarna_start.tpl',
        '@tcklarna/tcklarna_external_payments.tpl'       => 'views/smarty/templates/admin/tcklarna_external_payments.tpl',
        '@tcklarna/tcklarna_emd_admin.tpl'               => 'views/smarty/templates/admin/tcklarna_emd_admin.tpl',
        '@tcklarna/tcklarna_orders.tpl'                  => 'views/smarty/templates/admin/tcklarna_orders.tpl',
        '@tcklarna/tcklarna_messaging.tpl'               => 'views/smarty/templates/admin/tcklarna_messaging.tpl',
        '@tcklarna/tcklarna_shipping.tpl'                => 'views/smarty/templates/admin/tcklarna_shipping.tpl',
        //admin par
        '@tcklarna/tcklarna_country_creds.tpl'           => 'views/smarty/templates/admin/tcklarna_country_creds.tpl',
        '@tcklarna/tcklarna_header.tpl'                  => 'views/smarty/templates/admin/tcklarna_header.tpl',
        '@tcklarna/tcklarna_lang_spec_conf.tpl'          => 'views/smarty/templates/admin/tcklarna_lang_spec_conf.tpl',
    ),
    'blocks'      => array(
        array(
            'template' => 'widget/minibasket/minibasket.tpl',
            'block'    => 'widget_minibasket',
            'file'     => 'views/smarty/blocks/minibasket_widget_minibasket.tpl',
        ),
        array(
            'template' => 'page/shop/start.tpl',
            'block'    => 'start_manufacturer_slider',
            'file'     => 'views/smarty/blocks/start_widget_manufacturer.tpl',
        ),
        array(
            'template' => 'layout/header.tpl',
            'block'    => 'header_main',
            'file'     => 'views/smarty/blocks/header_main.tpl',
        ),
        array(
            'template' => 'page/details/inc/productmain.tpl',
            'block'    => 'details_productmain_variantselections',
            'file'     => 'views/smarty/blocks/productmain_variantselection.tpl',
        ),
        array(
            'template' => 'layout/footer.tpl',
            'block'    => 'footer_main',
            'file'     => 'views/smarty/blocks/footer_footer_main.tpl',
        ),
        array(
            'template' => 'page/checkout/payment.tpl',
            'block'    => 'select_payment',
            'file'     => 'views/smarty/blocks/payment_select_payment.tpl',
        ),
        array(
            'template' => 'page/checkout/basket.tpl',
            'block'    => 'checkout_basket_next_step_top',
            'file'     => 'views/smarty/blocks/basket_checkout_basket_next_step_top.tpl',
        ),
        array(
        ...
        array(
            ...
            'file'     => 'views/smarty/blocks/payment_change_payment.tpl',
        ),
        array(
            'template' => 'page/checkout/order.tpl',
            'block'    => 'order_basket',
            'file'     => 'views/smarty/blocks/order_order_basket.tpl',
        ),
        array(
            'template' => 'page/checkout/order.tpl',
            'block'    => 'shippingAndPayment',
            'file'     => 'views/smarty/blocks/order_shippingAndPayment.tpl',
        ),
        array(
            'template' => 'page/checkout/order.tpl',
            'block'    => 'checkout_order_next_step_bottom',
            'file'     => 'views/smarty/blocks/order_checkout_order_next_step_bottom.tpl',
        ),
        array(
            'template' => 'page/details/inc/productmain.tpl',
            'block'    => 'details_productmain_tobasket',
            'file'     => 'views/smarty/blocks/productmain_details_productmain_tobasket.tpl',
        ),
        array(
            'template' => 'page/checkout/thankyou.tpl',
            'block'    => 'checkout_thankyou_info',
            'file'     => 'views/smarty/blocks/thankyou_checkout_thankyou_info.tpl',
        ),
        array(
            'template' => 'page/checkout/inc/steps.tpl',
            'block'    => 'checkout_steps_main',
            'file'     => 'views/smarty/blocks/steps_checkout_steps_main.tpl',
        ),
        array(
            'template' => 'form/fieldset/user_billing.tpl',
            'block'    => 'form_user_billing_country',
            'file'     => 'views/smarty/blocks/user_billing_form_user_billing_country.tpl',
        ),
        array(
            'template' => 'layout/footer.tpl',
            'block'    => 'footer_main',
            'file'     => 'views/smarty/blocks/tcklarna_law_notice.tpl',
        ),
        array(
            'template' => 'order_main.tpl',
            'block'    => 'admin_order_main_form',
            'file'     => 'views/smarty/blocks/admin/order_main_admin_order_main_form.tpl',
        ),
        array(
            'template' => 'email/html/order_cust.tpl',
            'block'    => 'email_html_order_cust_paymentinfo_top',
            'file'     => 'views/smarty/blocks/order_cust_email_html_order_cust_paymentinfo_top.tpl',
        ),
        array(
            'template' => 'form/fieldset/user_shipping.tpl',
            'block'    => 'form_user_shipping_country',
            'file'     => 'views/smarty/blocks/user_shipping_form_user_shipping_country.tpl',
        ),
        array(
            'template' => 'order_overview.tpl',
            'block'    => 'admin_order_overview_billingaddress',
            'file'     => 'views/smarty/blocks/admin/order_overview_admin_order_overview_billingaddress.tpl',
        ),
        array(
            'template' => 'order_article.tpl',
            'block'    => 'admin_order_article_header',
            'file'     => 'views/smarty/blocks/admin/order_article_admin_order_article_header.tpl',
        ),
        array(
            'template' => 'order_list.tpl',
            'block'    => 'admin_order_list_filter',
            'file'     => 'views/smarty/blocks/admin/order_list_admin_order_list_filter.tpl',
        ),
        array(
            'template' => 'payment_main.tpl',
            'block'    => 'admin_payment_main_form',
            'file'     => 'views/smarty/blocks/admin/payment_main_admin_payment_main_form.tpl',
        ),
    ),
    'settings'    => array(),
    'events'      => array(
