...
class KlarnaConsts
{
    ...
    const KLARNA_MANUAL_DOWNLOAD_LINK = 'https://wiki.fatchip.de/public/faqklarnaox7';
    ...
    {
        return ['AT', 'DK', 'FI', 'FR', 'DE', 'IT', 'NL', 'NO', 'ES', 'SE', 'CH', 'GB'];
    }
    ...
    public static function getCustomerTypes() {
        return [
            'B2C'     => ['person'],
            'B2B'     => ['organization'],
            'B2C_B2B' => ['person', 'organization'],
            'B2B_B2C' => ['organization', 'person'],
            'B2BOTH'  => ['organization', 'person'] // old config value
        ];
    }
}
