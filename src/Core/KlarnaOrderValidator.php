    ...
    protected function validateOxidProductsBuyable($mergedProducts)
    {
        ...
        foreach ($mergedProducts as $itemKey => $itemAmount) {
            ...
            if (!$oArticleObject->isLoaded()) {
                $this->_aResultErrors['ERROR_MESSAGE_ARTICLE_ARTICLE_DOES_NOT_EXIST'] = $oArticleObject->getFieldData(
                    'oxartnum'
                );
            ...
            if (!$oArticleObject->isBuyable()) {
                $this->_aResultErrors['ERROR_MESSAGE_ARTICLE_ARTICLE_NOT_BUYABLE'] = $oArticleObject->getFieldData(
                    'oxartnum'
                );
