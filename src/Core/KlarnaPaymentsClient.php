...
class KlarnaPaymentsClient extends KlarnaClientBase
{
    ...
    public function createOrUpdateSession()
    {
        ...
        [$requestBody, $splittedUpdateData] = $this->formatOrderData();
    ...
    protected function formatOrderData()
    {
        if ($this->_oKlarnaOrder instanceof KlarnaPayment) {
            ...
            if ($this->_oKlarnaOrder->isAuthorized()
                ...
                if ($aChangedData) {
                    ...
                    // update order data
                    return [json_encode($aChangedData), $splitted];
                }
                //@codeCoverageIgnoreStart
                return null;
                //@codeCoverageIgnoreEnd
        ...
        // create order data
        return [parent::formatOrderData(), null];  // without user information
    }
    ...
    {
        $userData = [];
        $filterKeys = ['customer', 'attachment', 'billing_address', 'shipping_address'];
